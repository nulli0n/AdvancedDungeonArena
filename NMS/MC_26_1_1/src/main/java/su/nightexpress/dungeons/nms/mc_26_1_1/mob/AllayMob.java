...
public class AllayMob extends Allay implements DungeonHolder, MobBrainConfigurable<@NotNull Allay> {

    public AllayMob(@NotNull ServerLevel world) {
        super(EntityType.ALLAY, world);
    }

    protected Brain.Provider<@NotNull Allay> brainProvider() {
        return MobBrain.brainProvider(this, MobBrain::getActivities);
    }

    @Override
    protected @NotNull Brain<@NotNull Allay> makeBrain(final Brain.Packed packedBrain) {
    ...
    @Override
    public void setBrain(@NotNull Brain<@NotNull Allay> brain) {
        this.brain = brain;
    }
}
