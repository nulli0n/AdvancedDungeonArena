...
import su.nightexpress.dungeons.nms.mc_26_1_1.brain.behavior.impl.PrepareRamTarget;

public class GoatMob extends Goat implements DungeonHolder, MobBrainConfigurable<@NotNull Goat> {
    ...
    public GoatMob(@NotNull ServerLevel level) {
        ...
        this.getBrain().setMemory(MemoryModuleType.RAM_COOLDOWN_TICKS, TIME_BETWEEN_RAMS.sample(this.level().getRandom()));
    }

    protected Brain.Provider<@NotNull Goat> brainProvider() {
        return MobBrain.brainProvider(this, GoatMob::getActivities);
    }
    ...
    public static ImmutableList<ActivityData<Goat>> getActivities(Goat pet) {
        ...
        return ImmutableList.of(
                ...
                ActivityData.create(Activity.RAM,
                    ImmutableList.of(
    ...
    @Override
    public void setBrain(@NotNull Brain<@NotNull Goat> brain) {
        this.brain = brain;
    }
}
