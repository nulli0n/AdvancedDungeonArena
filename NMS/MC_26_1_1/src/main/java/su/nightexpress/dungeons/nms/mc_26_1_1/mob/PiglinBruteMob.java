...
public class PiglinBruteMob extends PiglinBrute implements DungeonHolder, MobBrainConfigurable<PiglinBrute> {
    ...
    @Override
    public void setBrain(@NotNull Brain<PiglinBrute> brain) {
        this.brain = brain;
    }
}
