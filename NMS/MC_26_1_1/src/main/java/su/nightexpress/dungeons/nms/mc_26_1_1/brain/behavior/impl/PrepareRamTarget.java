package su.nightexpress.dungeons.nms.mc_26_1_1.brain.behavior.impl;
...
import su.nightexpress.dungeons.nms.mc_26_1_1.mob.GoatMob;
...
public class PrepareRamTarget<E extends PathfinderMob> extends Behavior<E> {
    ...
    protected void stop(ServerLevel level, E goat, long i) {
        ...
        if (!brain.hasMemoryValue(MemoryModuleType.RAM_TARGET)) {
            ...
            brain.setMemory(MemoryModuleType.RAM_COOLDOWN_TICKS, GoatMob.TIME_BETWEEN_RAMS.minInclusive());
        }
