...
public class PiglinMob extends Piglin implements DungeonHolder, MobBrainConfigurable<@NotNull Piglin> {
    ...
    protected Brain.Provider<Piglin> brainProvider() {
        return MobBrain.brainProvider(this, PiglinMob::getActivities);
    }
    ...
    public static ImmutableList<ActivityData<Piglin>> getActivities(Piglin pet) {
    ...
    @Override
    public void setBrain(@NotNull Brain<@NotNull Piglin> brain) {
        this.brain = brain;
    }
}
